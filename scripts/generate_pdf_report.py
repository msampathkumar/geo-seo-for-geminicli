...
def generate_report(data, output_path="GEO-REPORT.pdf"):
    ...
    if quick_wins:
        ...
        default_wins = [
            "Allow all Tier 1 AI crawlers in robots.txt (GPTBot, GeminiBot, PerplexityBot)",
    ...
    elements.append(Paragraph(
        "This report was generated by the GEO-SEO Gemini CLI Tool. "
    ...
    if len(sys.argv) < 2:
        ...
        sample_data = {
            ...
            "crawler_access": {
                ...
                "GeminiBot": {"platform": "Gemini", "status": "Allowed", "recommendation": "Keep allowed"},
